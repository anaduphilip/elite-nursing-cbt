      ...
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ background: darkMode ? '#16213e' : 'white', borderRadius: 20, padding: 24, boxShadow: '0 4px 15px rgba(0,0,0,0.1)' }}>
          ...
          <div style={{ display: 'flex', gap: 12, marginBottom: 24, borderBottom: '2px solid #e0e0e0', paddingBottom: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <button onClick={() => setActiveTab('ratingSettings')} style={{ background: activeTab === 'ratingSettings' ? '#1e3c72' : 'transparent', color: activeTab === 'ratingSettings' ? 'white' : '#1e3c72', padding: '10px 24px', border: activeTab === 'ratingSettings' ? 'none' : '1px solid #1e3c72', borderRadius: 8, cursor: 'pointer', fontWeight: 'bold' }}>Rating Settings</button>
          </div>
          ...
          <AdjustPremiumModal
            ...
            setAdjustResult={setAdjustResult} 
